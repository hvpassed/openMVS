...
public:
	...
	bool DenseReconstruction(int nFusionMode=0, bool bCrop2ROI=true, float fBorderROI=0, bool skip=false, const String& segProH5Path=String());
	...
	bool saveImgRef(MVS::DenseDepthMapData &  data);
